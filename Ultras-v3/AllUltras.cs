...
//cs_include Scripts/Ultras-v3/UltraDependencies/UltraQueue.cs
//cs_include Scripts/Ultras-v3/CoreDependencies/CoreBots2.cs
//cs_include Scripts/Ultras-v3/CoreDependencies/CoreAdvanced2.cs
//cs_include Scripts/Ultras-v3/IndividualUltras/UltraEzrajal.cs
//cs_include Scripts/Ultras-v3/IndividualUltras/UltraWarden.cs
//cs_include Scripts/Ultras-v3/IndividualUltras/UltraEngineer.cs
//cs_include Scripts/Ultras-v3/IndividualUltras/UltraAvatarTyndarius.cs
...
public class AllUltras
{
    private static CoreEngine Core => _Core ??= new CoreEngine();
    private static CoreEngine _Core;
    ...
    {
        UltraQueue.PublishBossCompletionStatuses(Ultra, Bot, BossSyncFile, bosses);
        ...
        foreach (string boss in sharedBosses)
        {
            switch (boss)
            {
                ...
                case "UltraWarden":
                    ...
                    break;
                case "UltraEngineer":
                    new UltraEngineer_v3().ScriptMain(Bot);
                    break;
                case "UltraAvatarTyndarius":
                    new UltraAvatarTyndarius_v3().ScriptMain(Bot);
                    break;
                default:
