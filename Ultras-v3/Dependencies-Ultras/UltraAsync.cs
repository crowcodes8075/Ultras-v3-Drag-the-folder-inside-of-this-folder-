...
public class UltraAsync
{
    ...
    public static void StartTauntLoop(IScriptInterface bot, CoreBots2 C, CoreEngine2 engine, DateTime fightStart, int taunterIndex, int taunterCount = 2, Func<bool>? shouldSkipTaunt = null, int pulseIntervalSec = 5)
    {
    ...
    private static void TauntPulseLoop(IScriptInterface bot, CoreBots2 C, CoreEngine2 engine, DateTime fightStart, int taunterIndex, int taunterCount, Func<bool>? shouldSkipTaunt = null, int pulseIntervalSec = 5)
    {
        int lastPulse = -1;
    ...
    public static void TauntPresses(IScriptInterface bot, CoreBots2 C, CoreEngine2 engine)
    {
        var start = DateTime.UtcNow;
