...
description: Ultra Avatar Tyndarius v3 — Ball1TaunterAttackTyn1 + Ball1TaunterAttackTyn2 + Ball2Taunter1 + Ball2Taunter2 with pulse-driven targeting.
*/
...
public class UltraAvatarTyndarius_v3
{
    ...
    private const string Ball1TaunterAttackTyn1 = "ArchPaladin";
    private const string Ball1TaunterAttackTyn2 = "Lord Of Order";
    private const string Ball2Taunter1 = "StoneCrusher";
    private const string Ball2Taunter2 = "King's Echo";

    private static readonly string[][] UltraClassesByRole =
    {
        new[] { Ball1TaunterAttackTyn1 },
        new[] { Ball1TaunterAttackTyn2 },
        new[] { Ball2Taunter1 },
        new[] { Ball2Taunter2 }
    };
    ...
    private void Prep()
    {
        ...
        else if (className == Ball1TaunterAttackTyn2) _role = "Ball1TaunterAttackTyn2";
    ...
    private void Fight()
    {
        ...
        else if (_role == "Ball1TaunterAttackTyn2")
        {
            C.Logger("[UltraAvatarTyndarius-v3] Ball1TaunterAttackTyn2 — reading fight start time.");
            fightStartTime = UltraAsync.GetFightTime(Ultra, C, fightTimeSyncPath);
        ...
        while (!Bot.ShouldExit && !_wipeCts.IsCancellationRequested)
        {
            ...
            {
                // Ball1Taunters — taunt ball1 (left orb), attack Tyndarius normally;
                // 1s before taunt pulse, switch to ball1 (left orb) to taunt it
