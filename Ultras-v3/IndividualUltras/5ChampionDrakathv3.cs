...
public class ChampionDrakath_v3
{
    ...
    private void Fight()
    {
        ...
        if (_role == "Taunter1")
        {
            ...
            UltraAsync.StartTauntLoop(Bot, C, Engine, fightStartTime, 0, 3, pulseIntervalSec: 4);
        }
        else if (_role == "Taunter2")
        {
            ...
            UltraAsync.StartTauntLoop(Bot, C, Engine, fightStartTime, 1, 3, pulseIntervalSec: 4);
        }
        else if (_role == "Taunter3")
        {
            C.Logger("[ChampionDrakath-v3] Taunter3 — reading fight start time.");
            fightStartTime = UltraAsync.GetFightTime(Ultra, C, fightTimeSyncPath);
            UltraAsync.StartTauntLoop(Bot, C, Engine, fightStartTime, 2, 3, pulseIntervalSec: 4);
        }
