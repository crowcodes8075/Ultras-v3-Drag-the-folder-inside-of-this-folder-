...
public class UltraSpeaker_v3
{
    ...
    private void EquipPresetClasses()
    {
        ...
        Ultra.EquipClassSync(classSlots, armySize, "ultra_speaker_class-v3.sync", allowDuplicates);
    }
    ...
    private void Fight()
    {
        ...
        const string wipeDeadSyncFile = "UltraSpeakerWipeDead.sync";
        const string wipeAliveSyncFile = "UltraSpeakerWipeAlive.sync";
        ...
        // Without this, if 3 clients write `:1:` before the 4th writes anything,
        // CheckArmyProgressBool sees only 3 activeMembers and returns true prematurely.
        ...
        DateTime lastWipeTime = DateTime.MinValue;
        ...
        while (!Bot.ShouldExit)
        {
            ...
            if (UltraGeneral.ArmyWipeHelperWithTaunters(Ultra, Bot, wipeDeadSyncFile, wipeAliveSyncFile, ref armyWipeDetected, ref fightStartTime, ref lastWipeTime))
                continue;
