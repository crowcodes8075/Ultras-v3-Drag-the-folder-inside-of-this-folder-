...
public class UltraAvatarTyndarius_v3
{
    ...
    private const string Ball1Taunter1AttackBall2 = "ArchPaladin";
    ...
    private void Prep()
    {
        ...
        if (className == Ball1Taunter1AttackBall2) _role = "Ball1Taunter1AttackBall2";
    ...
    private void Fight()
    {
        ...
        if (_role == "Ball1Taunter1AttackBall2")
        {
            C.Logger("[UltraAvatarTyndarius-v3] Ball1Taunter1AttackBall2 (Primary) — setting fight start time.");
