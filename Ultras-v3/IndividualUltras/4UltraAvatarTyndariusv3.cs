...
description: Ultra Avatar Tyndarius v3 — ball phase targeting with 3 taunters and army sync.
*/
...
public class UltraAvatarTyndarius_v3
{
    ...
    private const string Ball2Taunter = "StoneCrusher";
    private const string Ball2Killer = "King's Echo";
    private const string Tyn1Taunter = "ArchPaladin";
    private const string Tyn2Taunter = "Lord Of Order";
    ...
    private bool IsTaunter()
    {
        ...
        return className == Ball2Taunter || className == Tyn1Taunter || className == Tyn2Taunter;
    }

    private bool IsTynTaunter()
    {
        string? className = Bot.Player.CurrentClass?.Name;
        return className == Tyn1Taunter || className == Tyn2Taunter;
    }
    ...
    private void Fight()
    {
        ...
        while (!Bot.ShouldExit)
        {
            ...
            // ── Ball2Taunter / Ball2Killer roles ────────────────────────────────
            if (!IsTynTaunter() && Bot.Player.CurrentClass?.Name == Ball2Taunter)
            {
                if (ball2Alive)
                {
                    AttackTarget(3);
            ...
            if (bothDead || (Bot.Player.CurrentClass?.Name != Ball2Taunter && Bot.Player.CurrentClass?.Name != Ball2Killer))
            {
